            ...
            <div class="card p-4">
                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link active btn-warning" href="{{ url('semak')}}">Tekan Sini Untuk Semak Keputusan Penempatan Murid</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link active btn-primary" href="{{--route('murid_isi.name')--}}">Log Masuk (Admin/Pegawai Sahaja)</a>
                        </li>
                    </ul>
