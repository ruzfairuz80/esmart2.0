...
<body class="app header-fixed sidebar-fixed aside-menu-fixed pace-done sidebar-lg-show">
    ...
    <div class="card">
        ...
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link active btn-primary" href="{{ url('semak') }}">Keluar Sistem</a>
            </li>
			 ...
			 @endif
                    ...
                    <table class='table table-bordered table-striped'>
                        ...
                        <tr>
                            ...
                            <th>15 MAC 2022 HINGGA 21 MAC 2022</th>
                        </tr>
                        <tr>
                        ...
                        <thead>
                            ...
                            <!--tr>
                                ...
                                <th>
                                    ...
                                    <!--a id="more" href="#"
                                        onclick="$('.details').slideToggle(function(){$('#more').html($('.details').is(':visible')?'TUTUP RAYUAN':'MOHON RAYUAN');});">MOHON
                                        RAYUAN</a-->
                                    <!--div class="details" style="display:none">
						<div  class="card-header bg-primary">TEMPOH RAYUAN: 24 FEB HINGGA 4 MAC 2022</div>
					<div class="card">
                                        <form action="{{route('rayuan.name')}}" method="POST">
                                            ...
                                            <select class="form-select" id="SR1" name="SR1" onchange="GetSelectedTextValue(this)">   
                                            ...
                                            <select class="form-select" id="SR2" name="SR2" onchange="GetSelectedTextValue(this)">   
